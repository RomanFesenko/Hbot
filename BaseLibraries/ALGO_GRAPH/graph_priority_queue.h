...
// с поддержкой операции изменени€ приоритета
...
class graph_priority_queue
{
   ...
   // ¬ызывающа€ сторона должна обеспечить чтобы
   // новый приоритет действительно был больше старого
   ...
   // ¬ызывающа€ сторона должна обеспечить чтобы
   // новый приоритет действительно был меньше старого
