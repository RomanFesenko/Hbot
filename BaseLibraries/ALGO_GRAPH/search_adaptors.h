...
// поведение алгоритма зависит от наличия
// специальных функций членов в ограничителе поиска

// наличие обработчика впервые посещаемых вершин
...
// наличие унарного обработчика релаксируемых ребер
template<class _Restr,class node_t>
...
// наличие бинарного обработчика релаксируемых ребер
// 2-ой арг - новый вес который может быть присвоен to -ноду
template<class _Restr,class node_t>
...
// наличие обработчика умирающего нода
template<class _Restr,class node_t>
...
// Чаще всего  search_restrictor может быть представлен
// комбинацией независимых функторов так что его
// можно множественно наследовать от _base_node_filter,_base_edge_filter
