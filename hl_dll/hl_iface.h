...
enum ItemIdentifiers
{
    ...
    id_health_getter=     (1 << 20),// вручную
    id_armour_getter=     (1 << 21),// вручную
    id_elevator_button=   (1 << 22),// вручную
    id_observation_point= (1 << 23),// вручную

    id_error=             (1 << 31) //-2 млрд (для 32 - бит)
};
...
struct hl_to_bot_funcs
{
    ...
    int  (*pfnPlayers)(void**); // живые игроки
    int  (*pfnFakePlayers)(void**); // боты
    ...
    // наличие/ отсутствие/установка предметов
