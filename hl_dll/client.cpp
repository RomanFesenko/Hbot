...
//CMapGrafViewer * glMapGrafViewer;
...
void ClientCommand( edict_t *pEntity )
{
    ...
    if(!Clock::is_init)
     {CBaseEntity::Create("clock", Vector(0,0,0), Vector(0,0,0));}
	...
	else if(glServerCommandProcessor(pcmd)){}// BOT
...
void ServerDeactivate( void )
{
    ...
    //FreeLibrary(GetModuleHandle("hbot.dll"));
}
