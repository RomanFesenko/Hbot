...
class CTask
{
    ...
    public:
    // flags indicating the possibility of overriding
    ...
    // whether to move, and if to move then where
    virtual move_t GetNativeMove()const{return {};}

    // set of flags from hl_iface.h: jump, shoot, reload, etc.
    ...
    //override GetNativeMove,GetNativeView,GetNativeActivity
...
class CFSMTask:public CTask
{
    ...
    // optional function performed when
    ...
    public:
    // current state and transition function
